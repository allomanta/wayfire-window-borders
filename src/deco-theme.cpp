				       ...
				       const button_state_t &state) const
{
	...
	wf::color_t base = { 0.60, 0.60, 0.63, 0.36 };
	...
	if (fabs(state.hover_progress) > 1e-3) {
		switch (button) {
		case BUTTON_CLOSE:
			base = { 242.0 / 255.0, 80.0 / 255.0, 86.0 / 255.0,
				 0.63 };
			break;

		case BUTTON_TOGGLE_MAXIMIZE:
			base = { 57.0 / 255.0, 234.0 / 255.0, 73.0 / 255.0,
				 0.63 };
			break;

		case BUTTON_MINIMIZE:
			base = { 250.0 / 255.0, 198.0 / 255.0, 54.0 / 255.0,
				 0.63 };
			break;
	...
	/** Draw the base */
	cairo_set_source_rgba(cr, base.r + 0.0 * state.hover_progress,
